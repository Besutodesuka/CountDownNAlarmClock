...
HD_PWD='C:/Users/bestk/Desktop/KMUTT/CPE222/CountDownNAlarmClock/CountDownNAlarmClock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_clock_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_clock_module.tcl -notrace
